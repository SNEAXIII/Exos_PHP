...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 23 avr. 2023 à 23:05
...
CREATE TABLE `horraire` (
  `id_jour` int(2) NOT NULL,
  `intitule_jour` varchar(10) NOT NULL,
  `heure_matin_debut` varchar(10) DEFAULT NULL,
  `heure_matin_fin` varchar(10) DEFAULT NULL,
  `heure_aprem_debut` varchar(10) DEFAULT NULL,
  `heure_aprem_fin` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `horraire` (`id_jour`, `intitule_jour`, `heure_matin_debut`, `heure_matin_fin`, `heure_aprem_debut`, `heure_aprem_fin`) VALUES
(1, 'Lundi', '8h00', '12h00', '14h00', '17h30'),
(2, 'Mardi', '8h00', '12h00', '14h00', '17h30'),
(3, 'Mercredi', '8h00', '12h00', NULL, NULL),
(4, 'Jeudi', '8h00', '12h00', '14h00', '17h30'),
(5, 'Vendredi', '8h00', '12h00', '14h00', '17h30');
...
--
ALTER TABLE `horraire`
  MODIFY `id_jour` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
('root', '[{\"db\":\"db_etudiants\",\"table\":\"horraire\"},{\"db\":\"db_etudiants\",\"table\":\"etudiant\"},{\"db\":\"db_etudiants\",\"table\":\"promotion\"}]');
...
('root', 'db_etudiants', 'etudiant', '{\"sorted_col\":\"`etudiant`.`id_etudiant` ASC\"}', '2023-02-27 20:30:24'),
('root', 'db_etudiants', 'horraire', '{\"sorted_col\":\"`horraire`.`heure_matin_debut` ASC\"}', '2023-04-23 20:43:59');
...
('root', '2023-04-23 21:04:50', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"fr\"}');
